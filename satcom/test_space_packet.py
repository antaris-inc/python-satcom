...
class TestSpacePacketHeader(unittest.TestCase):
    ...
    def test_space_packet_header_encode(self):
        ...
        ph = space_pkt_lib.SpacePacketHeader(length=27, port=0, sequence_number=1134, destination=23, command_number=132)
    ...
    def test_new_space_packet_from_bytes_too_much_data(self):
        ...
        dat = bytearray(1024)
        hdr = space_pkt_lib.SpacePacketHeader(port=1, sequence_number=4000, destination=253, command_number=56)
