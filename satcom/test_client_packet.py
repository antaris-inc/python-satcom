...
class TestClientPacketHeader(unittest.TestCase):
    ...
    def test_client_packet_header_encode(self):
        ...
        ph = client_pkt_lib.ClientPacketHeader(length=10, hardware_id=755, sequence_number=12, destination=212, command_number=57)
    ...
    def test_client_packet_header_decode(self):
        ...
        want = client_pkt_lib.ClientPacketHeader(length=13, hardware_id=1023, sequence_number=4, destination=253, command_number=56)     
        got = client_pkt_lib.ClientPacketHeader.from_bytes(self, hdr)
    ...
    def test_new_client_packet_to_bytes_small_frame(self):
        ...
        hdr = client_pkt_lib.ClientPacketHeader(hardware_id=1023, sequence_number=1, destination=253, command_number=56)
    ...
    def test_client_packet_from_bytes_small_frame(self):
        ...
        pkt = client_pkt_lib.ClientPacket(val)
    ...
    def test_client_packet_from_bytes_empty_frame(self):
        ...
        unittest.assertIsNone(pkt.err(), msg=pkt.err())
        unittest.assertEqual(len(pkt.data), 0, f"ERROR: Expected empty result, got {pkt.data}")
